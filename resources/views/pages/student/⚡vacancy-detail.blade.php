                            ...
                            <div class="mt-4 pt-4 border-t border-surface-dim">
                                ...
                                <ul class="space-y-1.5 text-left">
                                    @foreach($existingApp->attachments as $attachment)
                                        <li>
                                            <a href="{{ route('attachments.download', $attachment) }}" target="_blank" class="text-xs text-primary hover:underline flex items-center gap-1 max-w-full">
                                                ...
                                                <span class="truncate block max-w-[200px]" title="{{ $attachment->file_name }}">
