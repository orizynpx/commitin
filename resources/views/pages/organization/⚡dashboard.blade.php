    ...
    @else
        ...
        <div>
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ Route::has('organization.events.create') ? route('organization.events.create') : '#' }}" class="bg-[#0f172a] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-black transition-colors flex items-center gap-2 shadow-sm">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                <div class="max-w-md mx-auto">
                    ...
                    <a href="{{ Route::has('organization.events.create') ? route('organization.events.create') : '#' }}" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold transition-colors shadow-sm inline-block">
