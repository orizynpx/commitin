...
<div class="max-w-6xl mx-auto py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ __('Rekrutmen Pelamar Kepanitiaan') }}</h1>
        <p class="text-gray-600">{{ __('Daftar masuk seluruh pelamar dari semua divisi event Anda.') }}</p>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-100 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                    ...
                    <th class="px-6 py-4">Event & Divisi</th>
            ...
            <tbody class="divide-y divide-gray-100 text-sm">
                @forelse($applications as $app)
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="font-semibold text-gray-800">{{ $app->vacancy->division }}</div>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <span class="text-xs text-gray-400">Pendaftaran kepanitiaan Anda belum menerima lamaran masuk saat ini.</span>
                        </td>
                    </tr>
                @endforelse
            </tbody>
