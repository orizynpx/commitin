        ...
        <div class="px-8 pb-8 relative">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end -mt-16 mb-4 gap-4">
                ...
                <div class="flex gap-3 w-full md:w-auto">
                    @if ($role !== 'admin')
                        <a href="{{ route('profile.edit') }}" class="flex-1 md:flex-none bg-primary text-white hover:bg-primary-container px-5 py-2.5 rounded-lg text-sm font-semibold transition-colors shadow-sm shadow-primary-fixed-dim flex items-center justify-center gap-2">
